...
const works: Work[] = [
  ...
  },
  {
    ...
    is_work: true,
    description: '企業や個人がマーケティングや顧客とのコミュニケーションを自動化するためのシステムの見積もりから要件定義、設計、実装、単体・結合試験までを経験しました。また、開発チーム（計10名）のリーダーを務めました。',
    ...
    point: 'LIFF開発やデプロイ整備、AWSなど経験がない領域が多い状態でのアサインでしたが、事前に自己学習したり、知見のある方に相談したり、cursorを活用したりすることで効率的に作業を行い、納期を遅らせることなく納品することができました。',
  },
  {
    id: 3,
    title: '船舶位置情報確認システム',
    image: '/icon-ship.svg',
    is_work: true,
    description: '船舶の位置情報を確認するシステムの詳細設計から実装、単体・結合試験までを経験しました。',
    period: '2024/05 - 2024/06 (2ヶ月)',
    technologies: ['HTML', 'SCSS', 'TailwindCSS', 'React.js', 'TypeScript', 'googleMapsApi', 'Figma'],
    point: '経験のあるgoogleMapsApiを使用した実装だったため当初予定されていたスケジュールよりも前倒しで実装ができました。また、余った期間で使い勝手がより良くなるように機能改修や追加機能の提案を行い、お客様から満足のいく機能になったと評価いただきました。',
  },
  {
    id: 4,
    title: '点呼アプリ支援システム',
    ...
    is_work: true,
    description: '出勤状況や社内連絡などを管理するシステムの設計・実装・テストを担当しました。',
  ...
  },
  {
    ...
    is_work: true,
    description: '植物の生育・収益を予測するシステムのフロントエンドとバックエンドの実装や設計、画面イメージ作成、後輩教育を行いました。また、3か月間プレイングマネジャーとして案件管理を経験しました。',
